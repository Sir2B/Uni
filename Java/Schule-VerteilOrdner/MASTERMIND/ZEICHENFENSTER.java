...
public class ZEICHENFENSTER
{
    ...
    {
        this(titel, 800, 650, Color.white);        
    }
    ...
    // loesche alle Buttons etc. wird zu Beginn bei Spielautomat aufgerufen. Nur temporaer!
    public void neuesFenster() {
        loescheAlles();
        steuerungSued.removeAll();
        steuerungOst.removeAll();
    }
