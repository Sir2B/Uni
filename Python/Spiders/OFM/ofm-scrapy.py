...
class OfmScraper(scrapy.Spider):
    name = "ofm"
    allowed_domains = ["onlinefussballmanager.de"]
    start_urls = ["http://www.onlinefussballmanager.de/game"]
    def __init__(self):
    ...
    def after_login(self, response):
        ...
        if "Spielername oder Kennwort falsch!" in response.body:
            ...
            return scrapy.Request('http://www.onlinefussballmanager.de/game', callback=self.parse_page)
